...
Essa camada é um serviço background em net6.0. Essa camada depende das camadas Aplicativo e Infraestrutura, no entanto, a dependência da infraestrutura é apenas para dar suporte à injeção de dependência. Portanto, apenas *Program.cs* deve fazer referência à infraestrutura.
